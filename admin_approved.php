...
<head>
  <meta charset="UTF-8">
  <title>Approved Applications - Admin</title>
...
<body>
  <div class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a href="admin_approved.php" class="active"><i class="fa-solid fa-check"></i><span>Approved</span></a>
  ...
  <div class="main-content">
    <div class="top-navbar">
      <div class="d-flex justify-content-between align-items-center">
        <h1 class="mb-0 h4"><i class="fa-solid fa-check me-2 text-success"></i> Approved Applications</h1>
        <a href="admin.php" class="btn btn-outline-primary"><i class="fa-solid fa-arrow-left me-2"></i> Back</a>
      </div>
    </div>

    <div class="table-container">
      <h4 class="mb-4">Approved Certificates</h4>
      <div class="table-responsive">
        <table class="table align-middle">
          <thead><tr><th>#</th><th>Application ID</th><th>Name</th><th>Course</th><th>Department</th><th>Purpose</th><th>Date</th><th>Action</th></tr></thead>
          <tbody>
            <?php 
            $i = 1;
            ...
            <tr>
              ...
              <td>
                <a href="view_application.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-primary" title="View Details"><i class="fa-solid fa-eye"></i> View</a>
              </td>
            </tr>
            <?php }} else { echo '<tr><td colspan="8" class="text-center">No approved applications</td></tr>'; } ?>
          </tbody>
        </table>
      </div>
    </div>
